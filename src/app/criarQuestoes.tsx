...
//                     {/* TÍTULO ACIMA DO CARD — fora da caixa branca */}
...
// ⬇️ agora a tela recebe navigation/route pra pegar a turma
export default function CriarQuestoes({ navigation, route }: any) {
    ...
    // ⬇️ Pega a turma/matéria vindas da tela anterior (com fallback)
    ...
    const handleSalvar = async () => {
        ...
        const novaPergunta = {
            ...
            indiceCorreta,
            explicacao,
            turma: turmaSelecionada,       // ⬅️ AGORA VAI A TURMA PRO BACK
            materia: materiaSelecionada,   // ⬅️ opcional, mas bate com seu db.json
        };
            ...
            <SafeAreaView style={styles.container}>
                <View style={styles.header}>
                    <TouchableOpacity
                        style={styles.roundIcon}
                        onPress={() => {
                            navigation.goBack(); // ⬅️ já aproveitei pra voltar
                        }}
                    >
                        <Ionicons name="chevron-back" size={22} color="#fff" />
                    </TouchableOpacity>
                ...
                <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
                    ...
                    {/* Só pra você ver visualmente a turma/matéria da questão */}
